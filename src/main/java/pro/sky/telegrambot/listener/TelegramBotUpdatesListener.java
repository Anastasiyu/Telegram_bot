...
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    private static String GREET_MSG = "Привет, рад помочь Вам!";
    private static String INVALID_CMD = "Извините, данная команда не поддерживается!";
    ...
    public int process(List<Update> updates) {
        updates.forEach(update -> {
            ...
            if (message.text().equals(STR_CMD)) {
                log.info("Command's been recieved: " + STR_CMD);
